...
alter system set db_recovery_file_dest_size = 3072M scope=both;
...
-- alter system set log_archive_dest_2='LOCATION=/unam-diplomado-bd/disk-05/JGMDIP01/arclogs' scope=spfile;
